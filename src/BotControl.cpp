...
void BotControl::pidAlgorithm(){
	...
	ROS_INFO("Forward Velocity: %f; Angle Velocity: %f; Orientation_error: %f, Distance: %f, Velocity %f", 
		trans_forward_, trans_angle_, error_angle_, scan_range_,trans_forward_);
